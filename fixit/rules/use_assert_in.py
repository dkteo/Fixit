...
class UseAssertInRule(CstLintRule):
    ...
    MESSAGE = "Use assertIn/assertNotIn instead of assertTrue/assertFalse for inclusion check. (https://docs.python.org/3/library/unittest.html#unittest.TestCase.assertIn)"
